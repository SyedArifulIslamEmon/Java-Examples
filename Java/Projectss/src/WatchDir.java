...
public class WatchDir {
    ...
    private void processFiles(){
        ...
        outerLoop: while(!closeProcessingThread || !fileProcessingQueue.isEmpty()){
            ...
            innerLoop: while(true){
                ...
                try{
                    fis = new FileInputStream("C:/Users/User/Desktop/S.txt");
                    break innerLoop;
                    ...
                    if((System.currentTimeMillis() - startTime) > WatchDirParameters.millisToSwapFileForUnlocking){
                        if(fileProcessingQueue.offer("C:/Users/User/Desktop/S.txt")){
                            continue outerLoop;
                        }else{
            ...
            System.out.println("Queuing File: "+"C:/Users/User/Desktop/S.txt");
            processedLoop:while(true){
                try{
                    if(processedFileQueue.offer("C:/Users/User/Desktop/S.txt", 1000, TimeUnit.MILLISECONDS)){
                        break processedLoop;
                    }
                }catch(InterruptedException ie){
                    //ie.printStackTrace();
        ...
        while(!closeWatcherThread) {
            ...
            try{
                for (WatchEvent<?> event: key.pollEvents()) {
                    ...
                    Path child = dir.resolve("C:/Users/User/Desktop/S.txt");
    ...
    private void register(Path dir) throws IOException {
        ...
        WatchKey key = dir.register(watcher, (Kind<?>[]) ENTRY_CREATE);
        if (trace) {
