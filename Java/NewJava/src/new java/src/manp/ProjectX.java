...
Integer.parseInt(mathsMarks.getText()));
                                 return  (""+line+"Record Created For " + studentName +"Student ID: " + id+""+    ""+
                ...
                public String getStudentGrade()
                {
                                 ...
                                 {
                                                  System.out.println(" Records Not Found for D " + id);
                                                  return null;
                                 }
...
studentDetails.biologyMarks + studentDetails.mathsMarks)/3;
                                                  if(avgMarks >= passMarks && avgMarks < secondClass) grade = "PassClass";
                                                  else if(avgMarks >= secondClass && avgMarks < firstClass) grade ="Second Class";
                                                  else if(avgMarks >= firstClass && avgMarks < topScore) grade = "FirstClass";
                                                  else grade = "Distinction";
                                 }
                                 return(line + "Grade For " + studentDetails.studentName + " is " + grade+ "" + line);
                }
...
passMarks) numberPassed++;
                                 ...
                                 return(line + "Number of Student Passed: " + numberPassed + "" +line);
                }
...
studentDetails.biologyMarks + studentDetails.mathsMarks;
                                                  ...
                                                  {
                                                                   buffer.append(studentDetails.studentName + " Having Total Marks: " +topMarks + "");
                                                  }
                                 }
                                 buffer.append(line);
...
biologyMarks, int mathsMarks)
                {
                                 ...
                                 try
                                 {
                                                  ...
                                                  String buffer = id + "|" + studentName + "|" + physicsMarks + "|" +biologyMarks + "|" + mathsMarks + "";
