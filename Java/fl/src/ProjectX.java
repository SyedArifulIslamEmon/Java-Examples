...
public class ProjectX extends JFrame implements ChangeListener, ActionListener {
	static int choice = 0;
	static String line = "--------------------------------";
...
biologyMarks, int mathsMarks)
			...
			BufferedReader br = new BufferedReader(fileInput);
			{
				...
				while ((str = br.readLine()) != null) {
					...
					if (Integer.parseInt(fields.nextToken()) == id) {
						...
						this.physicsMarks = Integer
								.parseInt(fields.nextToken());
						this.biologyMarks = Integer
								.parseInt(fields.nextToken());
	...
	public static int getNextID() {
		int id = 0;
		try {
			RandomAccessFile studentIDFile = new RandomAccessFile(
					Registration.idFile, "rw");
